---
title: P199. 查找和最小的 K 对数字
date: 2025-05-05T15:09:25+08:00
draft: false
description: 这个题目说的是，给你两个递增的整数数组 nums1 和 nums2，以及一个整数 K。分别从 nums1 和 nums2 各取一个数字，可以构成一个数字对。你要找出 nums1 和 nums2 可以构成的所有数字对中，和最小的 K 对数字。
categories:
  - AlgoCasts
  - LeetCode
tags:
