---
title: P144. 不限次数进行股票买卖的最大利润
date: 2025-05-05T15:09:05+08:00
draft: false
description: 这个题目说的是，给你一个整数数组，其中第 i 个元素表示的是第 i 天的股票价格，在不限制买卖次数的情况下，你要计算出买卖股票可以获得的最大利润。注意，你不能同时参与到多个交易当中，也就是你要先卖掉手上的股票，才能买进新的一股。
categories:
  - AlgoCasts
  - LeetCode
tags:
